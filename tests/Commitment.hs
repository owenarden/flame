...
class Commitment a where
  commit  :: Monad e => DPrin p -> IFC e (I p) (C p) a -> IFC e (I p) p a
  receive :: Monad e => DPrin p -> DPrin q -> IFC e (I q) p a -> IFC e (I q) (p ∧ (I q)) a
  open    :: Monad e => DPrin p -> DPrin q -> IFC e (I p) (p ∧ (I q)) a -> IFC e (I p) ((I p) ∧ q) a

i_commit :: Monad e => DPrin p -> IFC e (I p) (C p) a -> IFC e (I p) p a
i_commit p v = assume (((⊥)^←) ≽ (p^←)) (relabel v)
