...
flame: out
	...
	cp $(LIB)/ml/prims.ml $(LIB)/ml/FStar_IO.ml $(LIB)/ml/FStar_Set.ml $(LIB)/ml/FStar_ST.ml out
	(cd out; $(OCAMLOPT) -o Flame.o prims.ml FStar_IO.ml FStar_Set.ml FStar_ST.ml Flame_FLAM.ml Flame_IFC.ml)
