...
type instance AuthServerData (AuthProtect "macaroon-auth") = FLAC IO (I MemoServer) (I MemoServer) MemoAuth
...
genAuthServerContext = macaroonAuthHandler :. EmptyContext
