...
data CtlT e (n :: KPrin -> * -> *) (β :: KPrin) (pc :: KPrin) (l :: KPrin) a where
  UnsafeIFC :: Monad e => { runIFC :: e (n l a) } -> CtlT e n β pc l a

type IFC e β pc l a = CtlT e Lbl β pc l a

ifc_lift :: Monad e => Lbl l a -> IFC e β pc l a
ifc_lift  x = UnsafeIFC $ Prelude.return x

ifc_ebind :: (Monad e, l ⊑ l', l ⊑ pc, l ⊑ β) => Lbl l a -> (a -> IFC e β pc l' b) -> IFC e β' pc' l' b
ifc_ebind x f = UnsafeIFC $ runIFC $ f $ unsafeRunLbl x

ifc_apply :: (Monad e, pc ⊑ pc', β' ⊑ β) => IFC e β pc l a -> (Lbl l a -> IFC e β' pc' l' b) -> IFC e β' pc' l' b
ifc_apply x f = UnsafeIFC $ do a <- runIFC x
                               runIFC $ f a

instance Monad e => NMFLA (CtlT e) Lbl where
  lift    = ifc_lift 
  ebind   = ifc_ebind
  apply   = ifc_apply
